                    ...
                    <div class="contact_form">
                        ...
                        <form id="update" class="row" name="update" action="update.php" method="post">
                            <fieldset class="row-fluid">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="status" id="status" value="<?php echo $peserta['status']?>" class="form-control" placeholder="Status">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="reg_type" id="reg_type" value="<?php echo $peserta['reg_type']?>" class="form-control" placeholder="Registration Type">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="no_mai" id="no_mai" value="<?php echo $peserta['no_mai']?>" class="form-control" placeholder="No. Anggota MAI">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="price" id="price" value="<?php echo $peserta['price']?>" class="form-control" placeholder="Biaya">
                                </div>
                                <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
